...
public class CheckoutAction extends BaseAction {
	...
	public void clickNavbarCart() {
		...
		new Actions(DriverClass.getDriver()).moveToElement(cartDiv).click().perform();
	}
	...
	public void selectNewAddress() {
		...
		By newAddressRadio = By.xpath("//label[@for = 'input-payment-address-new']"); 
	...
	public void selectRegisterAccount() {
		...
		By registerRadio = By.xpath("//label[@for = 'input-account-register']"); 
	...
	public void enterBillingDetails(String firstName, String lastName, String company, String address1, String city,
	...
	public boolean isOrderPlacedSuccessfully() {
		...
		return wait.until(ExpectedConditions.visibilityOf(checkoutPage.orderConfirmationMessage)).isDisplayed();
	}

	public void enterRegistrationDetails(String firstName, String lastName, String email, String telephone,
			String password, String confirmPassword, String company, String address1, String address2, String city,
			String postCode, String country, String region) {
	...
	public boolean isEmptyCartMessageDisplayed() {
		return wait.until(ExpectedConditions.visibilityOf(checkoutPage.emptyCartMessage)).isDisplayed();
	}
}
