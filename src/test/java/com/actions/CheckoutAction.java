...
public class CheckoutAction extends BaseAction {
    ...
    public void clickShoppingCartFromPopup() {
        ...
        wait.until(ExpectedConditions
                .visibilityOf(
                        checkoutPage.productPageCheckoutBtn1))
                .click();
        ...
        System.out.println(
                "Clicked Shopping Cart link from popup");
    }
    ...
    public void enterBillingDetails(
        ...
        wait.until(ExpectedConditions
                .elementToBeClickable(
                        checkoutPage.regionStateSelect));
    ...
    public void clickSameBillingAddress() {
        ...
        if (!checkoutPage.sameBillingAddressCheckbox
                .isSelected()) {
    ...
    public void enterRegistrationDetails(
        ...
        wait.until(ExpectedConditions
                .visibilityOf(
                        checkoutPage.regFirstNameInput));
